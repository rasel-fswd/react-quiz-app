      ...
      <div className="mt-6 space-y-4">
        {question.options.map((option, i) => (
          <button
            ...
            disabled={hasAnswer}
            className={twMerge(
              'block text-gray-600 py-2 md:py-3 px-4 border border-gray-600 w-full rounded-full text-lg hover:bg-gray-600 hover:border-gray-700 hover:text-gray-200 disabled:cursor-not-allowed transition',
              hasAnswer
